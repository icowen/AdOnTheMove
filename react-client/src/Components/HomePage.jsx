...
class HomePage extends Component {
    ...
    async getMedia() {
        const response = await fetch('https://api.reveldigital.com/api/media?api_key='+`${constants.API_KEY}`)
    ...
    async getDevices() {
        const response = await fetch(`https://api.reveldigital.com/api/devices?api_key=${constants.API_KEY}&include_snap=true`)
            .catch(err => console.error("Failed API call: ", err));
        const json = await response.json();
